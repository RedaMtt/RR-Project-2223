...
if(!$stmt = $conn->prepare("DELETE FROM Vak WHERE Vak.Naam = ? and Vak.Taal = ? and Vak.Code = ?")){
...
if(!$stmt -> bind_param("ssi", htmlentities($postvars['Naam']), htmlentities($postvars['Taal']), $postvars['Code'])){
