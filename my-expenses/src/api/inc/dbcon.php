...
$servername = "ID369711_Project.db.webhosting.be";
$username = "ID369711_Project"; // username (zie Hosting)
$password = "azerty123"; // paswoord DATABANK (zie hosting)
$dbname = "ID369711_Project"; // naam databank (zie hosting ; zelf gekozen)
